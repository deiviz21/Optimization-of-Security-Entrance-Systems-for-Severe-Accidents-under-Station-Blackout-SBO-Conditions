...
if __name__ == "__main__":
    ...
    ruta = r"C:\TFM DAVID\SBO\CASO BASE copia\tcss_tfc_caudal\RESULTADOS.TXT"  # Results path that will allow us to read the concentration and presion values of different gases
